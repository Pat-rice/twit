...
var MEDIA_TYPE_CATEGORY_MAPPING = {
...
FileUploader.prototype._initMedia = function (cb) {
  ...
  if (MEDIA_TYPE_CATEGORY_MAPPING[mediaType]) {
    params.media_category = MEDIA_TYPE_CATEGORY_MAPPING[mediaType];
  }
  ...
  if (mediaFileSizeBytes < MAX_FILE_SIZE_BYTES) {
    self._twit.post('media/upload', params, cb);
  } else {
